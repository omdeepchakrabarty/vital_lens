...
class ModelInferenceService:
    ...
    def preprocess_video(self, video_bytes: bytes) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    def infer_raw_outputs(self, model_input: tuple[torch.Tensor, torch.Tensor]) -> dict[str, list[float]]:
        self.model.eval()
